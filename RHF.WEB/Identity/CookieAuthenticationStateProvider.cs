...
using System.Text;
using RHF.WEB.Identity.Models;
using Blazored.LocalStorage;

namespace RHF.WEB.Identity
{
    /// <summary>
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        try
        {
            ...
            var userResponse = await _httpClient.GetAsync("api/UserManager/manage/info");
           ...
           // userResponse.EnsureSuccessStatusCode();
            ...
            var userInfo = JsonSerializer.Deserialize<RHF.Shared.UserInfo>(userJson, jsonSerializerOptions);
